		...
		<form name="loginform" id="loginform" action="https://nguyenhuuphu2512.github.io/mywordpress/wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Đăng nhập">
					...
					<p id="nav">
								<a href="https://nguyenhuuphu2512.github.io/mywordpress/wp-login.php?action=lostpassword">Bạn quên mật khẩu?</a>
			</p>
					<script type="text/javascript">
...
/*  */
var userProfileL10n = {"user_id":"0","nonce":"bf21ab05ca"};
/*  */
</script>
